...
const ExplorePage = () => {
    ...
    return (
        <>
            ...
            <div className="bg-linear-to-b from-white to-gray-50 py-16 px-4 overflow-hidden">
                <div className="max-w-6xl mx-auto">
                    ...
                    ref={ref}>
                        {/* Men's Collection */}
                        <div className={`group relative overflow-hidden rounded-lg shadow-lg left-to-right-anim hover:shadow-2xl transition-shadow duration-500 cursor-pointer ${isVisible ? "visible" : ""}`}>
                            <img 
                                ...
                                className="w-full h-150 object-cover group-hover:scale-105 transition-transform duration-500"
                            />
                            <div className="absolute inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-500">
